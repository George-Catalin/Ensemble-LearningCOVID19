...
def submitdata():
    if request.method == "POST":
        ...
        path = "C:\\Users\\musel\\OneDrive\\Desktop\\FYPGeorgeMuselin\\GUI\\static\\{}".format(f.filename)
        f.save(path)
        print(path)
        ...
        print(img) 
        img.save("C:\\Users\\musel\\OneDrive\\Desktop\\FYPGeorgeMuselin\\GUI\\static\\inception_img.jpeg")  
        my_ans = {
             "label" : l , 
             "image" :  "./static/{}".format(f.filename),
            
             "imgincep" :   "C:\\Users\\musel\\OneDrive\\Desktop\\FYPGeorgeMuselin\\GUI\\static\\inception_img.jpeg",
